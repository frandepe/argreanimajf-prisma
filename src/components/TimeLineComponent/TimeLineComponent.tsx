      ...
      content: (
        <div>
          <p className="text-neutral-800 dark:text-neutral-200 text-xs md:text-sm font-normal mb-8">
            El sábado 22 de marzo de 2025, en el marco de la responsabilidad que nos confió con orgullo la Federación Argentina de Cardiología (@fac_cardio), llevamos a cabo el examen práctico de cinco nuevos instructores de RCP y DEA.
          </p>
