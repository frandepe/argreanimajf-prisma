        ...
        <div>
          ...
          <div className="grid grid-cols-2 gap-4">
            <Image
              ...
              width={500}
              height={500}
              className="rounded-lg object-top object-cover h-20 md:h-44 lg:h-60 w-full shadow-[0_0_24px_rgba(34,_42,_53,_0.06),_0_1px_1px_rgba(0,_0,_0,_0.05),_0_0_0_1px_rgba(34,_42,_53,_0.04),_0_0_4px_rgba(34,_42,_53,_0.08),_0_16px_68px_rgba(47,_48,_55,_0.05),_0_1px_0_rgba(255,_255,_255,_0.1)_inset]"
            />
            <Image
              ...
              width={500}
              height={500}
              className="rounded-lg object-bottom object-cover h-20 md:h-44 lg:h-60 w-full shadow-[0_0_24px_rgba(34,_42,_53,_0.06),_0_1px_1px_rgba(0,_0,_0,_0.05),_0_0_0_1px_rgba(34,_42,_53,_0.04),_0_0_4px_rgba(34,_42,_53,_0.08),_0_16px_68px_rgba(47,_48,_55,_0.05),_0_1px_0_rgba(255,_255,_255,_0.1)_inset]"
            />
            <Image
    ...
    },
    {
      ...
      content: (
        <div>
          ...
          <div className="grid grid-cols-2 gap-4">
            <Image
              src="https://res.cloudinary.com/dtbryiptz/image/upload/v1747676344/2022-1_mkrk81.png"
              alt="hero template"
              width={500}
              height={500}
              className="rounded-lg object-cover h-20 md:h-44 lg:h-60 w-full shadow-[0_0_24px_rgba(34,_42,_53,_0.06),_0_1px_1px_rgba(0,_0,_0,_0.05),_0_0_0_1px_rgba(34,_42,_53,_0.04),_0_0_4px_rgba(34,_42,_53,_0.08),_0_16px_68px_rgba(47,_48,_55,_0.05),_0_1px_0_rgba(255,_255,_255,_0.1)_inset]"
            />
            <Image
              src="https://res.cloudinary.com/dtbryiptz/image/upload/v1747676447/2022-2_evotqs.png"
              alt="feature template"
              width={500}
              height={500}
              className="rounded-lg object-cover h-20 md:h-44 lg:h-60 w-full shadow-[0_0_24px_rgba(34,_42,_53,_0.06),_0_1px_1px_rgba(0,_0,_0,_0.05),_0_0_0_1px_rgba(34,_42,_53,_0.04),_0_0_4px_rgba(34,_42,_53,_0.08),_0_16px_68px_rgba(47,_48,_55,_0.05),_0_1px_0_rgba(255,_255,_255,_0.1)_inset]"
    ...
    >
      <div >
        ...
        <p className="text-neutral-700 dark:text-neutral-300 text-sm md:text-base w-full text-center">
          ...
          Reanimación Cardiopulmonar (RCP). Nuestra misión es clara: salvar
          vidas a través de la educación, la prevención y la acción rápida ante
          emergencias.
        </p>
      </div>
      ...
      <div ref={ref} className="pb-7 md:pb-16">
        {data.map((item, index) => (
          <div key={index} className="flex justify-start pt-7 md:pt-16 md:gap-10">
